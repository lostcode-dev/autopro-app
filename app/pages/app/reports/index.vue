...
const reports = [
  { title: 'Comissões', description: 'Comissões por funcionário e OS.', icon: 'i-lucide-badge-percent', to: '/app/reports/commissions' },
  { title: 'Clientes', description: 'Receita e ticket médio por cliente.', icon: 'i-lucide-users', to: '/app/reports/customers' },
  { title: 'Inadimplentes', description: 'Clientes com pagamentos pendentes.', icon: 'i-lucide-alert-triangle', to: '/app/reports/debtors' },
  { title: 'Custos e Lucro', description: 'Análise de custos e margem.', icon: 'i-lucide-trending-up', to: '/app/reports/costs' },
  { title: 'Lucro', description: 'Evolução e detalhamento de lucro.', icon: 'i-lucide-circle-dollar-sign', to: '/app/reports/profit' },
  { title: 'Compras', description: 'Análise de compras por período.', icon: 'i-lucide-shopping-cart', to: '/app/reports/purchases' },
  { title: 'Fornecedores', description: 'Histórico por fornecedor.', icon: 'i-lucide-truck', to: '/app/reports/suppliers' },
  { title: 'Itens Vendidos', description: 'Serviços e peças mais vendidos.', icon: 'i-lucide-list-checks', to: '/app/reports/sales-items' }
]
</script>
        ...
        <div>
          ...
          <div class="grid grid-cols-1 sm:grid-cols-2 lg:grid-cols-4 gap-3">
            ...
            >
              <UPageCard
                :title="report.title"
                :ui="{ root: 'hover:ring-2 hover:ring-primary transition-all', title: 'text-sm' }"
              >
                <template #leading>
                  <UIcon :name="report.icon" class="text-lg text-primary" />
                </template>
                <template #trailing>
