        ...
        <div class="flex min-h-0 flex-1 flex-col p-4">
          ...
          >
            <template #toolbar-right>
              ...
              <UButton v-if="canUpdate" label="Novo imposto" icon="i-lucide-plus" size="sm" @click="openCreate" />
            </template>
            ...
            <template #type-cell="{ row }">
              <UBadge :label="TAX_TYPE_LABELS[row.original.type as string] ?? row.original.type" color="neutral" variant="subtle" size="xs" />
            </template>
                  ...
                  <div class="min-w-0 flex-1 space-y-3">
                    <div class="flex items-start justify-between gap-3">
                      <div class="min-w-0 space-y-1">
                        ...
                        <UBadge :label="TAX_TYPE_LABELS[tax.type as string] ?? tax.type" color="neutral" variant="subtle" size="xs" />
                      </div>
                      <div class="flex shrink-0 items-center gap-1">
                        <UButton v-if="canUpdate" icon="i-lucide-pencil" color="neutral" variant="ghost" size="xs" @click="openEdit(tax as Tax)" />
                        <UButton v-if="canUpdate" icon="i-lucide-trash-2" color="error" variant="ghost" size="xs" @click="requestRemove(tax as Tax)" />
                      </div>
                    </div>
